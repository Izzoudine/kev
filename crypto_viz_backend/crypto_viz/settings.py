...
- PostgreSQL pour toutes les données
- TimescaleDB pour séries temporelles (réseau Docker)
...
# Database
# PostgreSQL avec réseau Docker interne
DATABASES = {
    'default': {
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API complète pour la visualisation de données crypto en temps réel',
    'VERSION': '1.0.0',
...
PROMETHEUS_METRICS_EXPORT_PORT_RANGE = range(8001, 8002)
